...
class AppLocalizationsUr extends AppLocalizations {
  ...
  String get locationSettingsIntro =>
      'جب بھی ایپ کھلی ہو، Haven آپ کا مقام آپ کے حلقوں کے ساتھ شیئر کرتا ہے۔ اسے آن کریں تو Haven کے پس منظر میں ہوتے ہوئے بھی آپ کے حلقے اسے دیکھتے رہیں گے؛ اگر سسٹم Haven کو بند کر دے تو اپ ڈیٹس اُس وقت دوبارہ شروع ہوں گی جب آپ حرکت کریں یا سسٹم اگلی بار ایپ کو جگائے۔';
