...
class AppLocalizationsUr extends AppLocalizations {
  ...
  String get privacyHubSummary =>
      'Haven آپ کا مقام صرف انہی چھوٹے گروپوں کے ساتھ شیئر کرتا ہے جنہیں آپ منتخب کرتے ہیں اور جنہیں حلقے کہا جاتا ہے، اور فون سے نکلنے سے پہلے ہی اسے خفیہ کر دیتا ہے۔ نہ کوئی سائن اپ ہے اور نہ Haven کا کوئی سرور۔ آپ کا مقرر کردہ ظاہری نام اور تصویر عوامی ہیں، اور اُن کے ساتھ وہ کلیدیں اور ریلے فہرستیں بھی جو دوسروں کو آپ کو مدعو کرنے کے لیے درکار ہیں۔ نیچے دیے گئے صفحات یہ سب، اور باقی ہر بات، سادہ زبان میں بتاتے ہیں۔';
  ...
  String get privacyWhatHavenIsMeansForYou =>
      'کسی ریلے چلانے والے سے آپ کا مقام زبردستی نہیں لیا جا سکتا، کیونکہ جو سرور اسے لے جاتے ہیں وہ اسے پڑھ ہی نہیں سکتے۔ اس کی قیمت یہ ہے کہ کوئی آپ کی شناخت آپ کے لیے بحال بھی نہیں کر سکتا، اور جو کچھ آپ پہلے شائع کر چکے ہیں وہ شائع شدہ ہی رہتا ہے۔ کس چیز کا بیک اپ لینا ہے، یہ جاننے کے لیے \"آپ کی دو کلیدیں\" دیکھیں۔';
  ...
  String get privacyRelaysMeansForYou =>
      'ریلے آپ کا مقام کبھی نہیں دیکھتا، کیونکہ وہ فون سے نکلنے سے پہلے ہی خفیہ ہو چکا ہوتا ہے۔ البتہ وہ سب کچھ دیکھتا ہے جس کا عوامی ہونا ضروری ہے تاکہ لوگ آپ تک پہنچ سکیں: وہ کلیدیں جو دوسروں کو آپ کو مدعو کرنے کے لیے درکار ہوتی ہیں، اور وہ فہرستیں جو بتاتی ہیں کہ کون سے ریلے استعمال ہوں۔ آپ کا نام اور تصویر بھی عوامی ہیں، مگر وہ ریلے کے ایک الگ مجموعے پر جاتے ہیں۔ Haven شروع ہی سے آپ کو کام کرنے والے ریلے دے دیتا ہے، اس لیے آپ کو کچھ بدلنے کی ضرورت نہیں۔';

  @override
  String get privacyRelaysDetailIndexers =>
      'آپ کی اپنی فہرستوں سے الگ، Haven عوامی سرورز کے دو مقررہ گروہ استعمال کرتا ہے جنہیں آپ نہیں چنتے: آٹھ سرور دوسروں کے نام اور تصویریں ڈھونڈنے کے لیے، اور چھ سرور وہ کلیدیں ڈھونڈنے کے لیے جو انہیں مدعو کرنے کے لیے درکار ہوتی ہیں۔ یہ دونوں گروہ کبھی آپس میں نہیں ملتے۔ آپ پروفائل والے گروہ میں اپنے سرور شامل تو کر سکتے ہیں، مگر اِن آٹھ سرورز کو اس میں سے نکال نہیں سکتے۔ چاہے آپ نے اپنے لیے جو ریلے چنے ہوں وہ سب کے سب نجی ہوں، Haven پھر بھی دونوں گروہوں سے رابطہ کرتا ہے، اور ان میں سے ہر ایک آپ کا نیٹ ورک پتہ دیکھتا ہے۔';

  @override
  String get privacyRelaysDetailProfileLookups =>
      'ناموں اور تصویروں کے لیے، Haven ایک وقت میں ایک ہی شخص کے بارے میں پوچھتا ہے۔ ہر شخص کے لیے آپ کے آلے پر ایک سرور مقرر ہوتا ہے، اور اگر اُس سرور کے پاس اُس شخص کے بارے میں کچھ نہ ہو تو Haven صرف ایک اور سرور آزماتا ہے۔ چنانچہ کسی کو تلاش کرنے سے وہ شخص آٹھ میں سے زیادہ سے زیادہ دو سرورز پر ظاہر ہوتا ہے، پورے گروہ پر نہیں۔ Haven یہ تقرریاں خود سے دوبارہ نہیں بانٹتا، البتہ اگر سرورز کا مجموعہ بدل جائے تو یہ بدل جاتی ہیں۔ اس سے آپ کے سوالات سب ایک ہی سرور پر جانے کے بجائے بٹ جاتے ہیں۔ پھر بھی، ہر مقرر شدہ سرور کے پاس یہ مستقل ریکارڈ بنتا چلا جاتا ہے کہ آپ کا فون بار بار اُسی شخص کے بارے میں پوچھتا رہتا ہے، اور جب لوگ چند ہی ہوں تو اُن میں سے کئی کے لیے ایک ہی سرور مقرر ہو سکتا ہے۔ جب آپ اپنا نام یا تصویر محفوظ کرتے ہیں تو جو کچھ آپ نے محفوظ کیا وہ اُن سب پروفائل ریلے پر جاتا ہے جو آپ واقعی استعمال کر رہے ہیں، یعنی وہی آٹھ سرور منہا وہ جو Haven نے خارج کر دیے ہوں، اور مزید وہ جو آپ نے خود شامل کیے ہوں، چنانچہ ان میں سے ہر ایک کو آپ کی عوامی کلید معلوم ہو جاتی ہے۔';
  ...
  String get privacyWhatOthersSeeCannotPause =>
      'جب تک Haven کھلا ہے اور آپ کسی حلقے میں ہیں، آپ کا مقام ہر دو تین منٹ بعد خود ہی چلا جاتا ہے۔ عارضی طور پر روکنے کا کوئی بٹن نہیں ہے: \"مقام\" کے صفحے پر موجود سوئچ صرف یہ طے کرتا ہے کہ Haven کے پس منظر میں چلتے رہنے کے دوران یہ سلسلہ جاری رہے یا نہیں۔ اگر سسٹم Haven کو بند کر کے بالکل ختم کر دے تو شیئرنگ رک جاتی ہے۔ Android پر شیئرنگ Haven کو ایپ سوئچر سے ہٹا دینے کے بعد بھی جاری رہتی ہے اور فون دوبارہ چالو ہونے پر خود ہی پھر شروع ہو جاتی ہے؛ iPhone پر یہ اُس وقت تک رکی رہتی ہے جب تک آپ Haven نہ کھولیں۔ کسی حلقے کے ساتھ شیئر کرنا بند کرنے کے لیے، اسے کھولیں اور \"حلقہ چھوڑیں\" منتخب کریں۔';
  ...
  String get privacyWhatOthersSeeDetailTag =>
      'کسی حلقے کا ٹیگ اُس حلقے کی پوری عمر ایک ہی رہتا ہے، چنانچہ ریلے اس کے سارے پیغامات غیر معینہ مدت تک آپس میں جوڑ سکتا ہے۔ پروٹوکول یہ اجازت ضرور دیتا ہے کہ کوئی حلقہ نئے ٹیگ پر منتقل ہو جائے، مگر Haven آج یہ کام نہیں کرتا، اور منتقل ہونا بھی وہ نہیں مٹاتا جو ریلے پہلے ہی آپس میں جوڑ چکا ہے۔';
  ...
  String get privacyWhatOthersSeeDetailOnDevice =>
      'ہر رکن کا فون آپ سے ملا ہوا آخری مقام ایک دن کے بعد دکھانا بند کر دیتا ہے، اور اُسے تب حذف کرتا ہے جب وہ رکن اگلی بار Haven کھولے۔ یہ اُس ہر چیز سے الگ بات ہے جسے کسی رکن نے خود محفوظ کرنے یا اس کا اسکرین شاٹ لینے کا فیصلہ کیا ہو، اور اس پر Haven کا کوئی اختیار نہیں۔';

  @override
  String get privacyWhatOthersSeeDetailOneConnection =>
      'Haven ہر ریلے سے ایک ہی کنکشن کھولتا ہے اور اُس ریلے پر ہر کام اسی سے کرتا ہے۔ جہاں ایک ہی ریلے آپ کے دعوت نامے بھی لے جاتا ہے اور کسی حلقے کے پیغامات بھی، وہاں وہی اکلوتا کنکشن ایک ہی وقت میں آپ کی اپنی عوامی کلید کے نام آنے والے دعوت نامے بھی مانگتا ہے اور اُس حلقے کے پیغامات بھی اُس کے ٹیگ سے، اور یہی چیز ریلے کو دونوں کا آپس میں تعلق جوڑنے دیتی ہے۔ نئی تنصیب پر دونوں کے لیے وہی ریلے استعمال ہوتے ہیں۔';
  ...
  String get privacyInferenceActivityPattern =>
      'اُسی نمونے سے، جو ریلے آپ استعمال کرتے ہیں وہ تقریباً بتا سکتا ہے کہ آپ کب سرگرم ہوتے ہیں اور کتنی بار۔ جب تک Haven اسکرین پر ہے، اور iPhone پر جب تک پس منظر میں شیئرنگ اسے چلتا رکھے، Haven ہر بار آپ کے تقریباً سو میٹر حرکت کرنے پر ایک اضافی اپ ڈیٹ بھی بھیجتا ہے، مگر منٹ میں زیادہ سے زیادہ ایک بار۔ کئی گھنٹوں میں یہ کسی ریلے پر ظاہر کر سکتا ہے کہ آپ سفر میں تھے یا ایک ہی جگہ ٹھہرے ہوئے۔ یہ نمونہ کبھی ظاہر نہیں کرتا کہ آپ کہاں ہیں۔';
