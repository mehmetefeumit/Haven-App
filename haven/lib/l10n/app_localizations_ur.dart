...
class AppLocalizationsUr extends AppLocalizations {
  ...
  String commonPendingInvitations(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count زیر التوا دعوت نامے',
  ...
  String relaySettingsRestoreBody(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'آپ کے موجودہ $count ریلے Haven کے طے شدہ ریلے سے بدل دیے جائیں گے۔ اسے واپس نہیں کیا جا سکتا۔',
      one:
  ...
  String nameCircleMembersToInvite(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count ارکان کو دعوت دی جائیں گی',
  ...
  String nameCircleCreatedSnack(String name, int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'حلقہ \"$name\" بن گیا! $count دعوت نامے بھیجے گئے۔',
  ...
  String addMemberPartialDelivery(int sent, int total) {
    return 'دعوت نامے بھیج دیے گئے ($total میں سے $sent)۔ باقی کی ترسیل زیر التوا ہے۔';
  }
  ...
  String invitationCardSemantics(String circleName, String inviter, int count) {
    return '$circleName میں شامل ہونے کی دعوت، $inviter کی جانب سے، $count ارکان';
  }
  ...
  @override
  String get invitationPillChecking => 'آپ کا اِن باکس جانچا جا رہا ہے…';

  @override
  String get invitationPillCheckingAnnouncement =>
      'آپ کا اِن باکس جانچا جا رہا ہے';
  ...
  @override
  String get invitationPillUpToDate => 'سب کا جواب آ گیا · کوئی نئی چیز نہیں';

  @override
  String get invitationPillUpToDateAnnouncement =>
      'تمام اِن باکسز نے جواب دے دیا، کوئی نئی چیز نہیں';

  @override
  String invitationPillPartial(int responded, int total) {
    return '$total میں سے $responded اِن باکسز نے جواب دیا';
  }

  @override
  String get invitationPillOffline => 'آپ کے اِن باکس تک رسائی نہ ہو سکی';

  @override
  String get invitationPillOfflineAnnouncement =>
      'آپ کے اِن باکس تک رسائی نہ ہو سکی، دوبارہ کوشش کریں';

  @override
  String get invitationPillNoInbox => 'کوئی اِن باکس مرتب نہیں';

  @override
  String get invitationPillSetUp => 'مرتب کریں';

  @override
  String get invitationPillDone => 'ہو گیا';
