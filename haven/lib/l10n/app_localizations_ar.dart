...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get locationSettingsIntro =>
      'يشارك Haven موقعك مع دوائرك كلما كان التطبيق مفتوحًا. وإن فعّلت هذا الخيار، ظلّت دوائرك ترى موقعك بينما يعمل Haven في الخلفية. أما إذا أغلق النظام Haven، فتتوقف المشاركة إلى أن تفتحه من جديد؛ فعمليات إيقاظ التطبيق في الخلفية تجلب مواقع دوائرك فقط، وهي لا تُرسل موقعك أنت أبدًا.';
