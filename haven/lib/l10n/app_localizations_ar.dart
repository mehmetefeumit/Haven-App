...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get privacyHubSummary =>
      'لا يشارك Haven موقعك إلا مع المجموعات الصغيرة التي تختارها، وتُسمّى دوائر، ويُشفّره على هاتفك قبل أن يغادره. لا يوجد تسجيل ولا خادم يملكه Haven. والاسم المعروض والصورة اللذان تضبطهما علنيّان، ومعهما المفاتيح التي يحتاجها الآخرون لدعوتك وقوائم مُرحِّلاتك. وتشرح الصفحات التالية ذلك، وكل ما عداه، بلغة بسيطة.';
  ...
  String get privacyWhatHavenIsMeansForYou =>
      'لا يمكن إجبار أي مُشغِّل مُرحِّل على تسليم موقعك، لأن الخوادم التي تنقله لا تستطيع قراءته. والثمن أن لا أحد يستطيع استعادة هويتك لك، وأن كل ما نشرته من قبل يبقى منشورًا. راجع «مفتاحاك» لمعرفة ما يجب أن تنسخه احتياطيًا.';
  ...
  String get privacyRelaysMeansForYou =>
      'لا يرى المُرحِّل موقعك أبدًا، لأنه يُشفَّر قبل أن يغادر هاتفك. لكنه يرى ما يجب أن يكون علنيًا ليصل إليك الناس: المفاتيح التي يحتاجها الآخرون لدعوتك، والقوائم التي تحدّد أي المُرحِّلات تُستخدَم. واسمك وصورتك علنيّان أيضًا، لكنهما يذهبان إلى مجموعة مُرحِّلات منفصلة. ويبدأ Haven معك بمُرحِّلات تعمل، فليس عليك تغيير أي شيء.';

  @override
  String get privacyRelaysDetailIndexers =>
      'بمعزل عن قوائمك الخاصة، يستخدم Haven مجموعتين ثابتتين من الخوادم العامة لا تختارهما أنت: ثمانية خوادم للبحث عن أسماء الآخرين وصورهم، وستة خوادم للبحث عن المفاتيح اللازمة لدعوتهم. ولا تتقاطع المجموعتان أبدًا. ويمكنك إضافة خوادم خاصة بك إلى مجموعة الملف الشخصي، لكن لا يمكنك إخراج هذه الخوادم الثمانية منها. ويتصل Haven بالمجموعتين كلتيهما حتى إن كانت كل المُرحِّلات التي اخترتها لنفسك خاصة، ويرى كلٌّ من هذه الخوادم عنوان شبكتك.';

  @override
  String get privacyRelaysDetailProfileLookups =>
      'للبحث عن الأسماء والصور، يسأل Haven عن شخص واحد في كل طلب. ويُخصَّص لكل شخص خادم على جهازك، فإن لم يكن لدى ذلك الخادم شيء عن ذلك الشخص، جرّب Haven خادمًا واحدًا آخر. ولذلك فإن البحث عن شخص ما يكشف ذلك الشخص لخادمين اثنين على الأكثر من الخوادم الثمانية، لا للمجموعة كلها. ولا يعيد Haven توزيع هذه التخصيصات من تلقاء نفسه، وإن كانت تتبدّل إذا تغيّرت مجموعة الخوادم. وهذا يوزّع أسئلتك بدل أن تذهب كلّها إلى خادم واحد. ومع ذلك يتراكم لدى كل خادم مخصَّص سجلّ دائم بأن هاتفك يواصل السؤال عن شخص بعينه، وحين يكون الأشخاص قليلين، قد يُخصَّص لعدد منهم الخادم نفسه. وعندما تحفظ اسمك أنت أو صورتك، يذهب ما حفظته إلى كل مُرحِّلات ملفك الشخصي التي تستخدمها، أي الخوادم الثمانية بعد استبعاد ما استبعده Haven منها، ومعها ما أضفته أنت، فيعرف كلٌّ منها مفتاحك العام.';
  ...
  String get privacyWhatOthersSeeCannotPause =>
      'ما دام Haven مفتوحًا وأنت في دائرة، يُرسَل موقعك من تلقاء نفسه كل دقيقتين تقريبًا. ولا يوجد زرّ إيقاف مؤقّت: فالخيار الموجود في صفحة «الموقع» لا يتحكّم إلا في استمرار ذلك بينما يعمل Haven في الخلفية. أما إذا أغلق النظام Haven وأنهى تشغيله، فتتوقف المشاركة. وعلى Android، تستمر المشاركة حتى بعد إزاحة Haven من مبدّل التطبيقات، وتعود من تلقاء نفسها بعد إعادة تشغيل الجهاز. أما على iPhone فتبقى متوقفة إلى أن تفتح Haven. وإن أردت التوقّف عن المشاركة مع دائرة، فافتحها واختر «مغادرة الدائرة».';
  ...
  String get privacyWhatOthersSeeDetailTag =>
      'يبقى وسم الدائرة كما هو مدى عمر تلك الدائرة، فيستطيع المُرحِّل ربط كل رسائلها معًا إلى أجل غير مسمّى. ويسمح البروتوكول فعلًا بأن تنتقل الدائرة إلى وسم جديد، لكن Haven لا يفعل ذلك اليوم؛ وحتى لو فعل، فالانتقال لا يُلغي ما ربطه المُرحِّل من قبل.';
  ...
  String get privacyWhatOthersSeeDetailOnDevice =>
      'يتوقّف هاتف كل عضو عن عرض آخر موقع وصله منك بعد يوم واحد، ويحذفه في المرة التالية التي يفتح فيها ذلك العضو Haven. وهذا منفصل عمّا قد يختار العضو نفسه حفظه أو التقاطه بلقطة شاشة، ولا يملك Haven أي تحكّم في ذلك.';

  @override
  String get privacyWhatOthersSeeDetailOneConnection =>
      'يفتح Haven اتصالًا واحدًا بكل مُرحِّل، ويستخدمه لكل شيء على ذلك المُرحِّل. وحين يحمل مُرحِّل واحد دعواتك ورسائل دائرة معًا، يطلب ذلك الاتصال الواحد في الوقت نفسه الدعواتِ الموجّهة إلى مفتاحك العام أنت، ورسائلَ تلك الدائرة بوسمها، وهذا ما يتيح للمُرحِّل الربط بين الاثنين. وفي أي تثبيت جديد، تُستخدَم المُرحِّلات نفسها للأمرين معًا.';
  ...
  String get privacyInferenceActivityPattern =>
      'ومن هذا النمط، يستطيع مُرحِّل تستخدمه أن يعرف تقريبًا متى تكون نشطًا وكم مرة. وما دام Haven ظاهرًا على الشاشة، وكذلك على iPhone ما دامت المشاركة في الخلفية تُبقيه قيد التشغيل، فإن Haven يُرسل أيضًا تحديثًا إضافيًا كلما تحرّكت نحو مئة متر، بمعدّل مرة واحدة في الدقيقة على الأكثر. وعلى مدى ساعات، قد يكشف ذلك للمُرحِّل ما إذا كنت متنقّلًا أم ثابتًا في مكانك. لكن هذا النمط لا يكشف مكانك أبدًا.';
