...
class AppLocalizationsHi extends AppLocalizations {
  ...
  String get locationSettingsIntro =>
      'जब भी ऐप खुला होता है, Haven आपका स्थान आपके सर्कलों के साथ साझा करता है। इसे चालू करें और Haven के बैकग्राउंड में रहते हुए भी आपके सर्कल इसे देखते रहेंगे। अगर सिस्टम Haven को बंद कर देता है, तो साझाकरण रुक जाता है और तब तक दोबारा शुरू नहीं होता जब तक आप ऐप फिर से न खोलें। बैकग्राउंड में जगने पर Haven सिर्फ़ आपके सर्कलों के स्थान पाता है, आपका स्थान कभी नहीं भेजता।';
  ...
  String get privacyHubSummary =>
      'Haven आपका स्थान केवल उन छोटे समूहों के साथ साझा करता है जिन्हें आप चुनते हैं और जिन्हें सर्कल कहा जाता है, और आपके फ़ोन को छोड़ने से पहले ही उसे उसी पर एन्क्रिप्ट कर देता है। न कोई साइन-अप है, न कोई Haven सर्वर। सार्वजनिक सिर्फ़ एक ही चीज़ होती है: आपका सेट किया हुआ प्रदर्शन नाम और फ़ोटो। नीचे दिए गए पन्ने यह बात, और बाकी सब कुछ, सरल भाषा में समझाते हैं।';
  ...
  String get privacyWhatHavenIsMeansForYou =>
      'किसी से आपका डेटा सौंपने को नहीं कहा जा सकता, क्योंकि वह किसी के पास है ही नहीं। इसकी कीमत यह है कि आपकी पहचान भी कोई आपके लिए बहाल नहीं कर सकता। क्या बैकअप करना है, यह जानने के लिए \"आपकी दो कुंजियाँ\" देखें।';
  ...
  String get privacyRelaysMeansForYou =>
      'कोई रिले आपका स्थान कभी नहीं देखता, क्योंकि वह आपके फ़ोन से निकलने से पहले ही एन्क्रिप्ट हो जाता है। उसे वह ज़रूर दिखता है जिसका सार्वजनिक होना ज़रूरी है ताकि लोग आप तक पहुँच सकें: आपका नाम और फ़ोटो, वे कुंजियाँ जो दूसरों को आपको आमंत्रित करने के लिए चाहिए, और खुद आपकी रिले सूची। Haven आपको शुरू से ही चालू रिले देता है, इसलिए आपको कुछ भी बदलने की ज़रूरत नहीं है।';
  ...
  String get privacyWhatOthersSeeCannotPause =>
      'जब तक Haven खुला है और आप किसी सर्कल में हैं, आपका स्थान हर दो-तीन मिनट में अपने आप चला जाता है। रोकने का कोई बटन नहीं है: स्थान पन्ने का स्विच सिर्फ़ यह तय करता है कि ऐप बंद करने के बाद यह चलता रहे या नहीं। किसी सर्कल के साथ साझा करना बंद करने के लिए उसे खोलें और \"सर्कल छोड़ें\" चुनें।';
  ...
  String get privacyInferenceActivityPattern =>
      'उसी पैटर्न से, आप जिस रिले का इस्तेमाल करते हैं वह मोटे तौर पर जान सकता है कि आप कब सक्रिय रहते हैं और कितनी बार। Haven एक अतिरिक्त अपडेट तब भी भेजता है जब आप करीब सौ मीटर आगे बढ़ जाते हैं। कुछ घंटों में इससे किसी रिले को यह संकेत मिल सकता है कि आप चल रहे थे या एक ही जगह टिके थे। कहाँ थे, यह कभी नहीं दिखता।';
  ...
  String get circleDetailsRelaysNote =>
      'ये रिले इस सर्कल के बनने के समय आपके इनबॉक्स रिले से कॉपी किए गए थे, और इन्हें अभी बदला नहीं जा सकता। बाद में आपकी निजी रिले सूची में किए गए बदलाव इन्हें नहीं बदलते।';
  ...
  String get identityAdvancedDeleteBody =>
      'इससे इस फ़ोन से आपकी पहचान और सर्कल का सारा डेटा हट जाता है। इसके तहत पहले जो कुछ प्रकाशित हो चुका है, जिसमें आपका नाम, फ़ोटो और कुंजियाँ शामिल हैं, वह उन रिले पर बना रहता है जिनके पास वह है। अगर आप इसे वापस पाना चाहते हैं तो सुनिश्चित करें कि आपने अपनी गुप्त कुंजी का बैकअप ले लिया है।';
