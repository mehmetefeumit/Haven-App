...
class AppLocalizationsHi extends AppLocalizations {
  ...
  String get locationSettingsIntro =>
      'जब भी ऐप खुला होता है, Haven आपका स्थान आपके सर्कलों के साथ साझा करता है। इसे चालू करें और Haven के बैकग्राउंड में रहते हुए भी आपके सर्कल इसे देखते रहेंगे; अगर सिस्टम Haven को बंद कर देता है, तो आपके चलने पर या सिस्टम के अगली बार ऐप जगाने पर अपडेट फिर शुरू हो जाते हैं।';
