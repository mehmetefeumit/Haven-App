...
class AppLocalizationsFa extends AppLocalizations {
  ...
  String get locationSettingsIntro =>
      'Haven هر وقت برنامه باز باشد موقعیت مکانی‌ات را با حلقه‌هایت به اشتراک می‌گذارد. این را روشن کن تا حلقه‌هایت وقتی Haven در پس‌زمینه است هم آن را ببینند. اگر سیستم Haven را ببندد، اشتراک‌گذاری متوقف می‌ماند تا وقتی که دوباره بازش کنی؛ برنامه در پس‌زمینه فقط برای گرفتن موقعیت حلقه‌هایت بیدار می‌شود، نه برای فرستادن موقعیت خودت.';
