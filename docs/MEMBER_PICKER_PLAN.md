...
**[P4] D6 is DEFERRED — the owner has deferred the Settings privacy page
pending a major overhaul, so the directory's retention paragraph is not being
written now.** `privacyWhatOthersSeeMembersDirectory` exists in no ARB file. A
...
| **P4** | Typed-stranger resolve (D2). **The disclosure copy (D6) is deferred out of this phase** — the owner deferred the Settings privacy page pending a major overhaul; the drafted paragraph and the cost of deferring it are recorded in D6 and §14 | no | R1 (strangers) |
...
filing none: the manifest is what the privacy page's claims are checked against.
